...
use crate::{
    Connectable, DescribePorts, GenerateId, GetNodeId, GetPortDescriptors, GraphError,
...
impl ResonixGraph for Graph {
    fn add<P: DescribePorts, G: GetPortDescriptors<P>, C: Into<Connectable> + Deref<Target = G>>(
        &mut self,
        node: C,
