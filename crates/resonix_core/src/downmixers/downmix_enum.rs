use crate::{downmix_panning, downmix_panning_fast, downmix_simple, downmix_panning_to_buffer, downmix_simple_to_buffer, downmix_panning_fast_to_buffer};
...
impl Downmixer {
    ...
    pub fn as_downmixer_to_buffer(&self) -> impl for<'a> Fn(&[f32], u32, &'a mut [f32]) -> &'a mut [f32] {
        match self {
