...
impl GranularSynthesizerAction for GranularSynthesizer {
    ...
    fn new() -> Self {
        ...
        Self {
            ...
            grain_len_min: Percentage::from(Self::GRAIN_LEN_MIN),
            grain_len_max: Percentage::from(Self::GRAIN_LEN_MAX),
