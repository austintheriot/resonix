...
pub trait GetFrame<'a, 'c, S, UserData, ExtractedData>
where
    S: Sample,
{
...
impl<'a, 'c: 'a, S, Callback, UserData, ExtractedData>
    GetFrame<'a, 'c, S, UserData, (ExtractedData,)> for Callback
where
    S: Sample,
    Callback: Fn(&mut [S], ExtractedData),
    ExtractedData: FromContext<'a, 'c, UserData>,
{
    fn call<'b>(self, buffer: &'b mut [S], context: &'c AudioPlayerContext<UserData>) {
...
impl<'a, 'c: 'a, S, Callback, UserData, ExtractedData1, ExtractedData2>
    GetFrame<'a, 'c, S, UserData, (ExtractedData1, ExtractedData2)> for Callback
where
    S: Sample,
    Callback: Fn(&mut [S], ExtractedData1, ExtractedData2),
    ExtractedData1: FromContext<'a, 'c, UserData>,
    ExtractedData2: FromContext<'a, 'c, UserData>,
{
    fn call<'b>(self, buffer: &'b mut [S], context: &'c AudioPlayerContext<UserData>) {
        (self)(
            buffer,
...
impl<'a, 'c: 'a, S, Callback, UserData, ExtractedData1, ExtractedData2, ExtractedData3>
...
where
    ...
    ExtractedData1: FromContext<'a, 'c, UserData>,
    ExtractedData2: FromContext<'a, 'c, UserData>,
    ExtractedData3: FromContext<'a, 'c, UserData>,
{
    fn call<'b>(self, buffer: &'b mut [S], context: &'c AudioPlayerContext<UserData>) {
        (self)(
            buffer,
